...
class Bayes_Classifier:
   ...
   def __init__(self, trainDirectory = "movies_reviews/"):
      ...
      if os.path.isfile("pos_dict.txt") and os.path.isfile("neg_dict.txt"):
        print "pickled dictionaries found in directory, loading them into memory ..."
        self.pos_dictionary = self.load("pos_dict.txt")
        self.neg_dictionary = self.load("neg_dict.txt")
      else:
...
#print res
   ...
   def train(self):   
      ...
      self.save(self.pos_dictionary,"pos_dict.txt")
      self.save(self.neg_dictionary,"neg_dict.txt")
   ...
   def classify(self, sText):
      ...
      if result_neg - result_pos > 0.3 :
        best_prop = result_neg
        classifyAs = "negative"
      elif result_pos - result_neg > 0.3 :
